...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@dg-claw/tui";
...
const THEME_KEY = Symbol.for("@dg-claw/coding-agent:theme");
...
export function getSettingsListTheme(): import("@dg-claw/tui").SettingsListTheme {
	return {
