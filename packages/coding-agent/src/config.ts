...
export function getUpdateInstruction(packageName: string): string {
	...
	switch (method) {
		case "bun-binary":
			return `Download from: https://github.com/forsonny/DG-Claw/releases/latest`;
		case "pnpm":
...
export function getPackageDir(): string {
	...
	const envDir = process.env.DG_CLAW_PACKAGE_DIR;
	if (envDir) {
...
// =============================================================================
// App Config (from package.json dgClawConfig)
// =============================================================================

const pkg = JSON.parse(readFileSync(getPackageJsonPath(), "utf-8"));

export const APP_NAME: string = pkg.dgClawConfig?.name || "dg-claw";
export const CONFIG_DIR_NAME: string = pkg.dgClawConfig?.configDir || ".dg-claw";
export const VERSION: string = pkg.version;

// e.g., DG_CLAW_CODING_AGENT_DIR
...
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.DG_CLAW_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
	return `${baseUrl}#${gistId}`;
}

// =============================================================================
// User Config Paths (~/.dg-claw/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.dg-claw/agent/) */
