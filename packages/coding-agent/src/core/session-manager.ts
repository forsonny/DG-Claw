 ...
 * Encodes cwd into a safe directory name under ~/.dg-claw/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.dg-claw/agent/sessions/<encoded-cwd>/).
	 */
