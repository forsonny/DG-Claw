...
import { getModel, type OAuthCredentials, type OAuthProvider } from "@dg-claw/ai";
...
// ============================================================================
// OAuth API key resolution from ~/.dg-claw/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".dg-claw", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.dg-claw/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.dg-claw/agent/auth.json
 */
...
/** Path to the real dg-claw agent config directory */
export const PI_AGENT_DIR = join(homedir(), ".dg-claw", "agent");

/**
 * Get an AuthStorage instance backed by ~/.dg-claw/agent/auth.json
