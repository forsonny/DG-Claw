...
Prompt content.`,
		...
		it("should prefer project resources over user on name collisions", async () => {
			...
			const projectPromptsDir = join(cwd, ".dg-claw", "prompts");
			...
			const projectSkillDir = join(cwd, ".dg-claw", "skills", "collision-skill");
...
Project skill`,
			...
			const projectThemePath = join(cwd, ".dg-claw", "themes", "collision.json");
			mkdirSync(join(agentDir, "themes"), { recursive: true });
			mkdirSync(join(cwd, ".dg-claw", "themes"), { recursive: true });
		...
		it("should keep both extensions loaded when command names collide", async () => {
			...
			const projectExtDir = join(cwd, ".dg-claw", "extensions");
...
Content`,
		...
		it("should discover SYSTEM.md from cwd/.dg-claw", async () => {
			const piDir = join(cwd, ".dg-claw");
