...
```typescript
import type { ExtensionAPI } from "@dg-claw/coding-agent";
...
| Package | Purpose |
|---------|---------|
| `@dg-claw/coding-agent` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
| `@sinclair/typebox` | Schema definitions for tool parameters |
| `@dg-claw/ai` | AI utilities (`StringEnum` for Google-compatible enums) |
| `@dg-claw/tui` | TUI components for custom rendering |
...
```typescript
import { isToolCallEventType } from "@dg-claw/coding-agent";
...
```typescript
import { isBashToolResult } from "@dg-claw/coding-agent";
...
```typescript
import { createLocalBashOperations } from "@dg-claw/coding-agent";
...
```typescript
import type { AutocompleteItem } from "@dg-claw/tui";
...
```typescript
import { withFileMutationQueue } from "@dg-claw/coding-agent";
...
**Important:** Use `StringEnum` from `@dg-claw/ai` for string enums. `Type.Union`/`Type.Literal` doesn't work with Google's API.
...
- [read.ts](https://github.com/forsonny/DG-Claw/blob/main/packages/coding-agent/src/core/tools/read.ts) - `ReadToolDetails`
- [bash.ts](https://github.com/forsonny/DG-Claw/blob/main/packages/coding-agent/src/core/tools/bash.ts) - `BashToolDetails`
- [edit.ts](https://github.com/forsonny/DG-Claw/blob/main/packages/coding-agent/src/core/tools/edit.ts)
- [write.ts](https://github.com/forsonny/DG-Claw/blob/main/packages/coding-agent/src/core/tools/write.ts)
- [grep.ts](https://github.com/forsonny/DG-Claw/blob/main/packages/coding-agent/src/core/tools/grep.ts) - `GrepToolDetails`
- [find.ts](https://github.com/forsonny/DG-Claw/blob/main/packages/coding-agent/src/core/tools/find.ts) - `FindToolDetails`
- [ls.ts](https://github.com/forsonny/DG-Claw/blob/main/packages/coding-agent/src/core/tools/ls.ts) - `LsToolDetails`
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@dg-claw/coding-agent";
...
```typescript
import { createBashTool } from "@dg-claw/coding-agent";
...
Tools can provide `renderCall` and `renderResult` for custom TUI display. See [tui.md](tui.md) for the full component API and [tool-execution.ts](https://github.com/forsonny/DG-Claw/blob/main/packages/coding-agent/src/modes/interactive/components/tool-execution.ts) for how tool rows are composed.
...
```typescript
import { keyHint } from "@dg-claw/coding-agent";
...
```typescript
import { Text, Component } from "@dg-claw/tui";
...
```typescript
import { CustomEditor, type ExtensionAPI } from "@dg-claw/coding-agent";
import { matchesKey } from "@dg-claw/tui";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@dg-claw/coding-agent";
