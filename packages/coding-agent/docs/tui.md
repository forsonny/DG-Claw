...
**Source:** [`@dg-claw/tui`](https://github.com/forsonny/DG-Claw/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@dg-claw/tui";
...
```typescript
import { Container, type Focusable, Input } from "@dg-claw/tui";
...
Import from `@dg-claw/tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@dg-claw/tui";
```
...
```typescript
import { matchesKey, Key } from "@dg-claw/tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@dg-claw/tui";
...
```typescript
import { getMarkdownTheme } from "@dg-claw/coding-agent";
import { Markdown } from "@dg-claw/tui";
...
For letting users pick from a list of options. Use `SelectList` from `@dg-claw/tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@dg-claw/coding-agent";
import { DynamicBorder } from "@dg-claw/coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@dg-claw/tui";
...
```typescript
import { BorderedLoader } from "@dg-claw/coding-agent";
...
For toggling multiple settings. Use `SettingsList` from `@dg-claw/tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@dg-claw/coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@dg-claw/tui";
...
import { matchesKey, truncateToWidth } from "@dg-claw/tui";
