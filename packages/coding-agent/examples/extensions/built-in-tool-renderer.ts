...
import type { BashToolDetails, EditToolDetails, ExtensionAPI, ReadToolDetails } from "@dg-claw/coding-agent";
import { createBashTool, createEditTool, createReadTool, createWriteTool } from "@dg-claw/coding-agent";
