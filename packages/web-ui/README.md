...
Reusable web UI components for building AI chat interfaces powered by [@dg-claw/ai](../ai) and [@dg-claw/agent](../agent).
...
```bash
npm install @dg-claw/web-ui @dg-claw/agent @dg-claw/ai
```
...
```typescript
import { Agent } from '@dg-claw/agent';
import { getModel } from '@dg-claw/ai';
import {
  ChatPanel,
  AppStorage,
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@dg-claw/web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@dg-claw/web-ui';
...
```typescript
import { createExtractDocumentTool } from '@dg-claw/web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@dg-claw/web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@dg-claw/web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@dg-claw/web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@dg-claw/web-ui';
...
```typescript
import { SessionListDialog } from '@dg-claw/web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@dg-claw/web-ui';
...
```typescript
import { ModelSelector } from '@dg-claw/web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@dg-claw/web-ui';
...
- [sitegeist](https://sitegeist.ai) - Browser extension using dg-claw/web-ui
